  ...
  return (
    <div className="grid gap-6">
        ...
        <CardContent className="grid gap-4">
           <Link href="/dashboard/personal-info" className="flex items-center justify-between p-4 border rounded-lg cursor-pointer hover:bg-muted">
              <div className='flex items-center gap-4'>
                <User className="w-5 h-5 text-muted-foreground" />
                <span className="font-medium">Update Profile</span>
              </div>
           </Link>
            <Link href="/dashboard/documents" className="flex items-center justify-between p-4 border rounded-lg cursor-pointer hover:bg-muted">
                <div className='flex items-center gap-4'>
